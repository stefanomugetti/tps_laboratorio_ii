    ...
    public static class Liga
    {
        ...
        public static bool Harcodeo()
        {
            if (!ExisteArchivo())
            {
                ...
                Jugador jdr23 = new Jugador("Mariano", "Mugetti", 19, 1.82, 62.9, "Argentina", "Derecho", "River", 7895000, "Mediocampista", 34653645);
                Jugador jdr24 = new Jugador("Oscar", "Serna", 29, 1.62, 87.9, "Argentina", "Derecho", "River", 20097800, "Mediocampista", 34516645);
                Jugador jdr25 = new Jugador("Cristian", "Riquelme", 37, 1.92, 65.9, "Argelia", "Izquierdo", "River", 30005000, "Mediocampista", 28233645);
                Jugador jdr26 = new Jugador("Mauricio", "Zarate", 18, 1.72, 73.9, "Argentina", "Derecho", "River", 2000500, "Mediocampista", 28600645);
                Jugador jdr27 = new Jugador("Ezequiel", "Fabra", 17, 1.64, 64.8, "Ecuador", "Derecho", "River", 204655000, "Delantero", 27653640);
                Jugador jdr28 = new Jugador("Antonio", "Valencia", 29, 1.74, 65.4, "Argentina", "Derecho", "River", 2000500, "Delantero", 28253000);
                Jugador jdr29 = new Jugador("Frank", "Messi", 26, 1.76, 69.3, "Argentina", "Izquierdo", "River", 20225000, "Delantero", 28343605);
                Jugador jdr30 = new Jugador("Esteban", "Ronaldo", 24, 1.87, 72.2, "Colombia", "Derecho", "River", 3005000, "Defensa", 24853045);
                Jugador jdr31 = new Jugador("Alejandro", "Trojavcich", 32, 1.90, 73.4, "Argentina", "Derecho", "River", 900005000, "Defensa", 28452645);
                Jugador jdr32 = new Jugador("Carlos", "Alvarez", 27, 1.92, 67.1, "Argentina", "Derecho", "River", 40005000, "Defensa", 34623635);
                Jugador jdr33 = new Jugador("Roman", "Cairo", 35, 1.87, 69.0, "Argentina", "Izquierdo", "River", 50005000, "Defensa", 29460045);
                Jugador jdr34 = new Jugador("Enrique", "Ortiz", 25, 1.69, 70.3, "Bolivia", "Derecho", "River", 92005000, "Arquero", 40323642);
                ...
                Liga.AgregarEquipo(equipo5))
                {
                    ...
                    Archivos<bool>.DatosHarcodeados();
                    return true;
                }
            }
            else
