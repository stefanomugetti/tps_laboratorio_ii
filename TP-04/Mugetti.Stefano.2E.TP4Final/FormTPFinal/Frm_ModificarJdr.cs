    ...
    public partial class Frm_ModificarJdr : Form
    {
        ...
        private void ModificarJugador(Jugador jugadorAModificar)
        {
                   ...
                   double.TryParse(this.txt_Valor.Text, out double valor))
                {
                        ...
                        Validaciones.PosicionValida(this.cmb_Posicion.Text))
                    {
                        ...
                        if (equipoElegido != null)
                        {
                            ...
                            {
                                DBConnection.ModificarJugador(jugadorAModificar.Dni, this.txt_Nombre.Text, this.txt_Apellido.Text, (int)this.nud_Edad.Value, altura, peso, this.txt_Nacionalidad.Text, this.cmb_PieHabil.Text, this.txt_Equipo.Text, valor, this.cmb_Posicion.Text, dni);
            ...
            catch (DniException ex)
            {
                ...
                Archivos<string>.InformarError(ex.Message);
            }
        }
